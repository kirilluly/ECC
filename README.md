...
- **Public surface synced to the live repo** — metadata, catalog counts, plugin manifests, and install-facing docs now match the actual OSS surface: 63 agents, 249 skills, and 80 legacy command shims.
...
**That's it!** You now have access to 63 agents, 249 skills, and 80 legacy command shims.
...
| Commands | PASS: 80 commands   | PASS: 35 commands | **Claude Code leads** |
...
| **Commands** | 80                    | Shared | Instruction-based | 35 | 6 prompts |
